...
if( !class_exists( 'LilacBeauty_Woo_Listing_Tag' ) ) {

    class LilacBeauty_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'lilacbeauty_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('lilacbeauty_woo_listing_tag') ) {
	function lilacbeauty_woo_listing_tag() {
		return LilacBeauty_Woo_Listing_Tag::instance();
	}
}

lilacbeauty_woo_listing_tag();