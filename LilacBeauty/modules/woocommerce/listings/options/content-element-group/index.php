...
if( !class_exists( 'LilacBeauty_Woo_Listing_Option_Content_Element_Group' ) ) {

    class LilacBeauty_Woo_Listing_Option_Content_Element_Group extends LilacBeauty_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'lilacbeauty_woo_custom_product_template_content_options', array( $this, 'woo_custom_product_template_content_options'), 50, 1 );
        }
...
if( !function_exists('lilacbeauty_woo_listing_option_content_element_group') ) {
	function lilacbeauty_woo_listing_option_content_element_group() {
		return LilacBeauty_Woo_Listing_Option_Content_Element_Group::instance();
	}
}

lilacbeauty_woo_listing_option_content_element_group();